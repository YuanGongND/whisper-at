...
parser.add_argument("--data_path", type=str, default='path_to_your_data_file.json', help="the root path of data json file")

if __name__ == '__main__':
    args = parser.parse_args()
    data_path = args.data_path

    index_dict = make_index_dict('./class_labels_indices.csv')
