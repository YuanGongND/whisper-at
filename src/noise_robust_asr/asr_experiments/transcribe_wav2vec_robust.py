...
model = Wav2Vec2ForCTC.from_pretrained("facebook/wav2vec2-large-robust-ft-swbd-300h").to(device)

tar_path = '/data/sls/scratch/yuangong/whisper-a/noisy_speech_camera_text_w2v_large_robust/'
