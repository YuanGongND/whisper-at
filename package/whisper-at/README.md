...
**The best way to learn how to use Whisper-AT is this [Colab Script](). It is highly recommended to check the [Colab Script](). You can skip all below if you read it.**
